...
public final class TableDataMergeUtil {
    ...
    public static String tableDataCellDisplay(JsonNode rowData, String fieldKey) {
        ...
        return displayCellText(fieldKey, t);
    }
    ...
    private static String displayCellText(String fieldKey, String text) {
        if ("类型".equals(fieldKey)) {
            return TypeLabelUtil.forAutoGeneratedText(text);
        }
        return text;
    }
